...
// Fill items
void
QMLRedmineClient::fillItem( Item& item, QJsonObject* obj, QString value)
{
...
template<typename T>
void
QMLRedmineClient::fillDefaultFields( T& item, QJsonObject* obj)
{
...
QStringList
QMLRedmineClient::getErrorList( QNetworkReply* reply, QJsonDocument* json )
{
...
QMLRedmineClient::QMLRedmineClient( QObject* parent )
...
QMLRedmineClient::QMLRedmineClient( QString url, QObject* parent )
...
QMLRedmineClient::QMLRedmineClient( QString url, QString apiKey, bool checkSsl, QObject* parent )
...
QMLRedmineClient::QMLRedmineClient( QString url, QString login, QString password, bool checkSsl,
                                    QObject* parent )
...
QMLRedmineClient::init()
{
    ...
    connect( this, &RedmineClient::networkAccessibleChanged,
             this, &QMLRedmineClient::checkConnectionStatus );

    // Connect the initialised signal to the isConnected slot
    connect( this, &QMLRedmineClient::initialised, [&](){ checkConnectionStatus(); } );

    RETURN();
}

void
QMLRedmineClient::checkConnectionStatus()
{
...
QTime
QMLRedmineClient::getTime( const QString& stime )
{
    ENTER();
...
void
QMLRedmineClient::sendIssue( Issue item, SuccessCb callback, int id, QString parameters )
{
...
void
QMLRedmineClient::sendTimeEntry( TimeEntry item, SuccessCb callback, int id, QString parameters )
{
    ENTER()(id)(parameters);
...
void
QMLRedmineClient::retrieveCustomFields( CustomFieldsCb callback, CustomFieldFilter filter )
{
    ENTER();
...
void
QMLRedmineClient::retrieveEnumerations(QString enumeration, EnumerationsCb callback, QString parameters )
{
...
void
QMLRedmineClient::parseIssue( Issue& issue, QJsonObject* obj )
{
    ENTER();
...
void
QMLRedmineClient::retrieveIssue( IssueCb callback, int issueId, QString parameters )
{
...
void
QMLRedmineClient::retrieveIssues( IssuesCb callback, RedmineOptions options )
{
    ENTER()(options);
...
void
QMLRedmineClient::retrieveIssueCategories( IssueCategoriesCb callback, int projectId, QString parameters )
{
...
void
QMLRedmineClient::retrieveIssuePriorities( EnumerationsCb callback, QString parameters )
{
    ENTER()(parameters);
...
void
QMLRedmineClient::retrieveIssueStatuses( IssueStatusesCb callback, QString parameters )
{
    ENTER()(parameters);
...
void
QMLRedmineClient::retrieveMemberships( MembershipsCb callback, int projectId, QString parameters )
{
    ENTER()(projectId)(parameters);
...
void
QMLRedmineClient::parseProject( Project& project, QJsonObject* obj )
{
    ENTER();
...
void
QMLRedmineClient::retrieveProject( ProjectCb callback, int projectId, QString parameters )
{
    ENTER()(projectId)(parameters);
...
void
QMLRedmineClient::retrieveProjects(QString parameters )
{
    ENTER()(parameters);
    ...
    {
        ENTER();
        QQmlObjectListModel<qtredmine::Project > *projects = new QQmlObjectListModel<qtredmine::Project>();
        // Quit on network error
        if( reply->error() != QNetworkReply::NoError )
        {
            DEBUG() << "Network error:" << reply->errorString();
            projectsRetrieveComplete( projects, RedmineError::ERR_NETWORK, getErrorList(reply, json) );
            RETURN();
        }
        ...
        projectsRetrieveComplete( projects, RedmineError::NO_ERR, QStringList() );
...
void
QMLRedmineClient::retrieveTimeEntries( TimeEntriesCb callback, QString parameters )
{
    ENTER()(parameters);
...
void
QMLRedmineClient::retrieveTimeEntryActivities( EnumerationsCb callback, QString parameters )
{
    ENTER()(parameters);
...
void
QMLRedmineClient::retrieveTrackers( TrackersCb callback, QString parameters )
{
    ENTER()(parameters);
...
void
QMLRedmineClient::parseUser( User& user, QJsonObject* obj )
{
    ENTER();
...
void
QMLRedmineClient::retrieveCurrentUser()
{
    ENTER();
    ...
    auto cb = [=]( QNetworkReply* reply, QJsonDocument* json )
    {
        ...
        {
            DEBUG() << "Network error:" << reply->errorString();
            //            callback.setProperty(user,User())
            //            callback( User(), RedmineError::ERR_NETWORK, getErrorList(reply, json) );
            emit userRetrieveComplete(User(), RedmineError::ERR_NETWORK, getErrorList(reply, json) );
            RETURN();
        }
        ...
        parseUser( user, &obj );
        emit userRetrieveComplete(user, RedmineError::NO_ERR, QStringList() );
        //        qDebug()<<"OK "<<json->toJson();
...
void
QMLRedmineClient::retrieveUsers( UsersCb callback, QString parameters )
{
    ENTER()(parameters);
...
void
QMLRedmineClient::retrieveVersions( VersionsCb callback, int projectId, QString parameters )
{
    ENTER()(projectId)(parameters);
